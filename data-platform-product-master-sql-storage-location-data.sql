...
(
    ...
    CONSTRAINT `DataPlatformProductMasterStorageLocationDataStorageLocation_fk` FOREIGN KEY (`BusinessPartner`, `Plant`, `StorageLocation`) REFERENCES `data_platform_plant_storage_location_data` (`BusinessPartner`, `Plant`, `StorageLocation`)
