...
(
  ...
  `FileName`                       varchar(200) DEFAULT NULL,
    ...
    CONSTRAINT `DataPlatformProductMasterGeneralDocDataDocIssuerBusinessPartner_fk` FOREIGN KEY (`DocIssuerBusinessPartner`) REFERENCES `data_platform_business_partner_general_data` (`DocIssuerBusinessPartner`)
